...
**Address lines** - Address lines are used to carry the address bits from CPU to memory or IO device, addresses are always generated by CPU. Therefore address lines are uni-directional

* Based on the number of address lines present in the address we can determine the memory capacity of that system
