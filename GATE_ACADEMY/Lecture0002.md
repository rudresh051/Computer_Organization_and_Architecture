...
In above cell size was 8 bit. So I increased only number of cells NOT size of cells


Question - How many memory chips of size 32x2 bit are needed to design a memory of size 32x8 bit and how are they connected

![alt text](image-30.png)

No need of decoder as number of input lines for address in each memory chip is same as no. of bits
in the address generated by CPU  

![alt text](image-31.png)

Note - If we want to design a memory of size MxN bit, using memory chips of size  PxQ bit, then  
